...
{
    public class ValidacoesCelulasExcel
    {
        ...
        private void ValidacaoDecimal(object valor, string nomeCampo)
        {
            ...
            var decimalString = valor.ToString().Replace(",", ".");
        ...
        public void ValidarCampo(DataRow row, string nomeCampo, object valor)
        {
